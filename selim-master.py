...
global system
system = int(input(f"{decor.lye}[selim@choosesystem] >> "))
...
while True:
    print(decor.menu)
    ans = int(input(f"{decor.lye}[selim@main] >> {decor.res}"))
    if ans == 1 and system == 1:
        os.system('cls')
        nick = input(f"{decor.lye}entre le username bb >> ")
        ...
        os.system('cls')
        ip = input(f"{decor.lye}entre l'ipv4 bb >> ")
        ...
        vari = input(f"{decor.lye}[inquisiteur/main/carNphone/category] >> {decor.res}")

        if vari == "2":
            car_num = input(f"{decor.lye}entre la plaque d'imatriculation bb(а111аа77) >> ")
            try:
            ...
            phone = input(f"{decor.lre}entre le num de tel bb >> ")
